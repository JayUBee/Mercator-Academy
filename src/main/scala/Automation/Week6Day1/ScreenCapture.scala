...
object ScreenCapture extends App{
  ...
  val timeStamp = new SimpleDateFormat("yyyyMMdd_HH.mm.ss").format(new Date())
  ...
  FileHandler.copy(srcElement, new File("/Users/tayyab.butt/Documents/screenshots/TestResult_Specific.png")) // Save the screenshot of the element
